...
Until last year, I set a few macro-goals (7 last year, for example), and then for each macro-goal I would define **instrumental goal**, that are indicators that I can use to check If I did good or not. But I also tracks what macro-goals I worked towards to every day by tagging it in a journal, on the Day One app.
