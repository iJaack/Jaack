...
<img class="image" src="{{site.url}}/assets/images/projects/blockchain-201.png" />
...
Oggi quando scriviamo google.com, stiamo chiedendo a un server di dirci qual è l’indirizzo IP che ha google.com, anche l’IPFS l’ha inventato (esiste un sistema che trasforma parole in numeri). Tramite i seguenti passaggi: Striscia, Hash, Indirizzo IP.
...
## Token non fungibili: cryptogattini
